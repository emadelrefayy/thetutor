...
export const Navbar: React.FC = () => {
  ...
  return (
    <nav
      className="bg-slate-900 border-b border-slate-800 text-white shadow-2xl px-3 py-3 w-full overflow-hidden"
      dir="rtl"
    >
      <div className="max-w-7xl mx-auto flex flex-col gap-3">
        ...
        <div className="flex items-center justify-between px-2">
          <div className="flex items-center gap-4">
            ...
            <div>
              <h1 className="text-3xl sm:text-4xl font-black text-amber-400 tracking-wider drop-shadow-md">
                The Tutor
              </h1>
        ...
        <div className="w-full bg-slate-950/90 p-1.5 rounded-2xl border border-slate-800/80 shadow-inner">
          <div className="flex items-center gap-2 overflow-x-auto scrollbar-none snap-x snap-mandatory py-1 px-1">
            ...
            <Link
              to="/student"
              className={`shrink-0 flex-1 min-w-[110px] snap-center text-center py-2.5 px-3 rounded-xl text-xs font-extrabold transition-all ${
                isActive('/student')
