...
# 1. إنشاء مكون شريط البحث والفلترة
filter_component = """import React from 'react';
...
with open('src/components/CourseFilter.tsx', 'w', encoding='utf-8') as f:
    f.write(filter_component)

print("✅ Created CourseFilter component successfully!")
